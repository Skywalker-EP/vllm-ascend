...
def set_log2phy_map(self, layer_id, updated_log2phy):
    return self.model.layers[layer_id].mlp.experts.set_log2phy_map(updated_log2phy)
...
def model_register(model, model_config):
    ...
    model.set_log2phy_map = types.MethodType(set_log2phy_map, model)
